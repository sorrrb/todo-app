...
function init() { // Main screen controller function
  ...
  (0,_modules_handlers__WEBPACK_IMPORTED_MODULE_2__.checkLocalStorage)();
}
...
function updateLocalStorage() {
  ...
  let projects = _modules_task__WEBPACK_IMPORTED_MODULE_2__.projectManager.getProjects();
...
function generateProjectFolders() { // Creates projects folders and adds to DOM
  ...
  folders.forEach((folder) => {
    ...
    const tab = (0,_modules_load__WEBPACK_IMPORTED_MODULE_3__.createProjectFolder)(title, _assets_media_folder_svg__WEBPACK_IMPORTED_MODULE_1__, id);
    tab.addEventListener('click', tabHandler);
...
function checkLocalStorage() {
  if (localStorage.getItem('projects') === '[]' || !localStorage.getItem('projects')) {
    ...
    projectInfoParsed.forEach((project) => {
      ...
      const storedProjectObj = (0,_modules_task__WEBPACK_IMPORTED_MODULE_2__.createProject)(infoParsed.title, infoParsed.id);
      _modules_task__WEBPACK_IMPORTED_MODULE_2__.projectManager.addProject(storedProjectObj);

      todosParsed.forEach((todo) => {
        const todoParsed = JSON.parse(todo);

        const storedTodoObj = (0,_modules_task__WEBPACK_IMPORTED_MODULE_2__.createTodo)(todoParsed.title, todoParsed.description, todoParsed.deadline, todoParsed. priority);
